...
class SimpleDepositBlocktradesBridge extends React.Component {
    ...
    _renderDeposit() {
        const {replacedName: assetName, prefix} = utils.replaceName(this.props.asset.get("symbol"), !!this.props.asset.get("bitasset"));
    ...
    _renderCurrentBalance() {
        const {replacedName: assetName} = utils.replaceName(this.props.asset.get("symbol"), !!this.props.asset.get("bitasset"));
    ...
    render() {
        ...
        const {replacedName: assetName, prefix} = utils.replaceName(asset.get("symbol"), !!asset.get("bitasset"));
