...
export default class ConfirmModal extends React.Component {
    ...
    render() {
        ...
        let balanceSelections = balances.map(b => {
            ...
            return <div onClick={this._setBalance.bind(this, index)} className={"balance-row" + (index === this.state.balanceIndex ? " active": "")}><BalanceComponent balance={b.get("id")} /></div>;
        });
                        ...
                        <div style={{width: "100%", display: "table-row", float: "left", paddingBottom: 20}}>
                            ...
                            <div style={{display: "table-cell", float: "right", width: "70%"}}>
                                <label style={{width: "100%", margin: 0}}>
                                    <span className="inline-label" style={{margin: 0}}>
                                        <input type="text" />
                                        <span className="form-label" style={{paddingLeft: 0, paddingRight: 0}}>
