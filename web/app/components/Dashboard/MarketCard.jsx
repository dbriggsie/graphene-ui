...
class MarketCard extends React.Component {
	...
	render() {
		...
		function getImageName(asset) {		
			return asset.get('symbol').split(".").join("_").toLowerCase();
		}
			...
			<div className={cnames("grid-block no-overflow fm-container", this.props.className)} onClick={this.goToMarket.bind(this)}>
				<div className="grid-block vertical shrink">
					<div className="v-align">
						<img className="align-center" ref={imgName} onError={this._onError.bind(this, imgName)} style={{maxWidth: 70}} src={"/app/assets/asset-symbols/"+ imgName + ".png"} />
					</div>
				</div>
