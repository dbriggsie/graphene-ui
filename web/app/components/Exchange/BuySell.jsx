...
class BuySell extends React.Component {
    ...
    render() {
        ...
        let options = feeAssets.map(asset => {
            let {replacedName, prefix} = utils.replaceName(asset.get("symbol"));
            return <option key={asset.get("id")} value={index++}>{prefix}{replacedName}</option>;
        });
            ...
            <div className={this.props.className}>
                <div className="exchange-bordered buy-sell-container">
                    <div className={"exchange-content-header " + type}>
                        ...
                        {this.props.currentBridges ? <div className="float-right buy-sell-deposit">&emsp;<a onClick={this._onBuy.bind(this)}><Translate content="exchange.buy" />&nbsp;<span className="asset-name">{buyBorrowDepositName}</span></a></div> : null}
